...
class EyeBot < SlackRubyBot::Bot
    ...
    command 'list' do |client, data, _match|
        ...
        if posts_data.any?
            ...
            client.say(channel: data.channel, text: 'SubReddit does not seen to exist...', gif: 'sad')
        end
    end
...
SlackRubbyBot::Client.logger.level = Logger::WARN
